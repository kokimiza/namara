...
そのlang/typeが1度も公開されていない(archive.htmlに`<li>`が1つも無い、あるいはarchive.html自体が存在しない)場合は、これまで通り404になる。「今日の問題が見えなくなる」事態そのものを防ぐのは、あくまで運用側(担当者が毎日ちゃんと公開する)の責務であることは変わらない——ミドルウェアが直すのは「公開自体は済んでいるのに、日付が変わった一瞬だけ見えなくなる」という時計とのズレだけであり、「公開そのものを忘れている」ケースまで肩代わりするものではない。
